 ...
 *   VNPAY thành công    → CONFIRMED (tự động sau khi xác minh)
 *   Đối tác xác nhận    → CONFIRMED + partner status
...
public enum BookingStatus {
    ...
    CONFIRMED,               // VNPAY hợp lệ, chờ đối tác xác nhận giữ phòng hoặc đã giữ phòng
