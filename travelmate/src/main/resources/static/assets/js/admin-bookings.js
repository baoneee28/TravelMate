/**
 * ⛔ LEGACY FILE — KHÔNG CÒN ĐƯỢC IMPORT VÀO BẤT KỲ TEMPLATE NÀO
 * ================================================================
 * File này dùng window.TravelMateBookingStore (localStorage mock data).
 * bookings.html đã chuyển sang Thymeleaf server-side render từ MySQL.
 * Giữ lại để tham khảo lịch sử, KHÔNG import.
 * ================================================================
 */
